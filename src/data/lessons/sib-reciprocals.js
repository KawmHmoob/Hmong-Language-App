...
export const sibReciprocals = {
  ...
  steps: [
    ...
    },
    {
      ...
      items: [
        { hmong: 'Sib hlub', english: 'to love each other', note: '"Hlub" = to love / cherish.' },
        { hmong: 'Sib pab', english: 'to help each other', note: '"Pab" = to help.' },
        { hmong: 'Sib ntaus', english: 'to fight / hit each other', note: '"Ntaus" = to hit / strike.' },
        { hmong: 'Sib tham', english: 'to talk with each other', note: '"Tham" = to chat / converse.' },

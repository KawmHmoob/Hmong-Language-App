...
export const rivals = [
  { id: 'r1', name: 'HUGE PENIS DEVV', seasonPoints: 14780, weekPoints: 1240, clips: 238, level: 50 },
  { id: 'r2', name: 'Angel Vang', seasonPoints: 13950, weekPoints: 1580, clips: 221, level: 49 },
  { id: 'r3', name: 'Cassie', seasonPoints: 12840, weekPoints: 980, clips: 204, level: 48 },
  { id: 'r4', name: 'Lover', seasonPoints: 11920, weekPoints: 1370, clips: 189, level: 47 },
  { id: 'r5', name: 'PaoKhang', seasonPoints: 10750, weekPoints: 760, clips: 231, level: 46 },
  { id: 'r6', name: 'HmongYoungBoy', seasonPoints: 9840, weekPoints: 1150, clips: 176, level: 45 },
  { id: 'r7', name: 'MOD 301', seasonPoints: 8730, weekPoints: 640, clips: 198, level: 44 },
  { id: 'r8', name: 'Chong Moua', seasonPoints: 7920, weekPoints: 890, clips: 134, level: 43 },
  { id: 'r9', name: 'Vang', seasonPoints: 7310, weekPoints: 520, clips: 167, level: 42 },
  ...
  { id: 'r12', name: 'Thompson SMG', seasonPoints: 5980, weekPoints: 815, clips: 98, level: 39 },
  { id: 'r13', name: 'Jaysen Xiong', seasonPoints: 5640, weekPoints: 670, clips: 132, level: 38 },
  { id: 'r14', name: 'Spencer Bradshaw', seasonPoints: 5390, weekPoints: 950, clips: 167, level: 37 },
  { id: 'r15', name: 'Gh0stKillerHM', seasonPoints: 5120, weekPoints: 580, clips: 89, level: 36 },
  ...
  { id: 'r20', name: 'AlmightHM', seasonPoints: 3940, weekPoints: 650, clips: 76, level: 31 },
  { id: 'r21', name: 'Fong Vang', seasonPoints: 3710, weekPoints: 960, clips: 108, level: 30 },
  { id: 'r22', name: '.', seasonPoints: 3490, weekPoints: 410, clips: 183, level: 29 },
  { id: 'r23', name: 'Spikee', seasonPoints: 3280, weekPoints: 775, clips: 68, level: 28 },
  ...
  { id: 'r26', name: 'TRUMP2028', seasonPoints: 2740, weekPoints: 620, clips: 82, level: 25 },
  { id: 'r27', name: 'Yia Her', seasonPoints: 2610, weekPoints: 710, clips: 138, level: 24 },
  { id: 'r28', name: 'BigHmoobDick', seasonPoints: 2490, weekPoints: 480, clips: 95, level: 23 },
  { id: 'r29', name: 'BaoBaoVang', seasonPoints: 2370, weekPoints: 850, clips: 73, level: 22 },
  { id: 'r30', name: 'Olivia 1983', seasonPoints: 2260, weekPoints: 590, clips: 149, level: 21 },
  { id: 'r31', name: 'Ge Yang', seasonPoints: 2150, weekPoints: 930, clips: 109, level: 20 },
  { id: 'r32', name: 'Hunter', seasonPoints: 2040, weekPoints: 440, clips: 67, level: 19 },
  ...
  { id: 'r37', name: 'Phaaaaa Xyooj', seasonPoints: 1570, weekPoints: 820, clips: 115, level: 14 },
  { id: 'r38', name: 'Brooke', seasonPoints: 1490, weekPoints: 470, clips: 63, level: 13 },
  { id: 'r39', name: 'Thao Vang Lor', seasonPoints: 1420, weekPoints: 650, clips: 98, level: 12 },
  { id: 'r40', name: 'typicalwhitedude', seasonPoints: 1350, weekPoints: 720, clips: 81, level: 11 },
  ...
  { id: 'r45', name: 'Kajsiaaaab', seasonPoints: 1070, weekPoints: 740, clips: 93, level: 6 },
  { id: 'r46', name: 'T Bradshaw', seasonPoints: 1020, weekPoints: 380, clips: 58, level: 5 },
  { id: 'r47', name: 'PajNtaubMoua', seasonPoints: 980, weekPoints: 670, clips: 102, level: 5 },
  { id: 'r48', name: 'Sydney Peterson', seasonPoints: 940, weekPoints: 460, clips: 71, level: 4 },
  ...
  { id: 'r51', name: 'XiongWarrior', seasonPoints: 810, weekPoints: 630, clips: 79, level: 3 },
  { id: 'r52', name: 'Mckenna H', seasonPoints: 780, weekPoints: 490, clips: 52, level: 3 },
  { id: 'r53', name: 'VangLord420', seasonPoints: 750, weekPoints: 720, clips: 88, level: 3 },
  { id: 'r54', name: 'Brigham Young', seasonPoints: 720, weekPoints: 410, clips: 61, level: 3 },
  { id: 'r55', name: 'KubKub', seasonPoints: 690, weekPoints: 680, clips: 94, level: 2 },
  { id: 'r56', name: 'emma', seasonPoints: 660, weekPoints: 370, clips: 48, level: 2 },
  { id: 'r57', name: 'HmoobKing', seasonPoints: 630, weekPoints: 590, clips: 77, level: 2 },
  { id: 'r58', name: 'Daviss', seasonPoints: 600, weekPoints: 450, clips: 55, level: 2 },
  { id: 'r59', name: 'MouaLegacy', seasonPoints: 570, weekPoints: 810, clips: 82, level: 2 },
  { id: 'r60', name: 'Sophie & Micheal', seasonPoints: 540, weekPoints: 520, clips: 69, level: 2 },
  { id: 'r61', name: 'YeejYeej', seasonPoints: 510, weekPoints: 430, clips: 73, level: 1 },
  { id: 'r62', name: 'Ryan the Dragon', seasonPoints: 490, weekPoints: 390, clips: 44, level: 1 },
  ...
  { id: 'r67', name: 'PaoPaoVang', seasonPoints: 390, weekPoints: 620, clips: 71, level: 1 },
  { id: 'r68', name: 'Olivia C', seasonPoints: 370, weekPoints: 410, clips: 48, level: 1 },
  { id: 'r69', name: 'HerHustle', seasonPoints: 350, weekPoints: 580, clips: 64, level: 1 },
  { id: 'r70', name: 'greedy', seasonPoints: 330, weekPoints: 330, clips: 42, level: 1 },
  { id: 'r71', name: 'YangSniper', seasonPoints: 310, weekPoints: 490, clips: 59, level: 1 },
  { id: 'r72', name: 'mia thompson', seasonPoints: 290, weekPoints: 280, clips: 37, level: 1 },
  ...
  { id: 'r76', name: 'Broooooklynnnnn', seasonPoints: 210, weekPoints: 250, clips: 33, level: 1 },
  { id: 'r77', name: 'KaoKaoHM', seasonPoints: 190, weekPoints: 470, clips: 46, level: 1 },
  { id: 'r78', name: 'D. Jensen', seasonPoints: 170, weekPoints: 220, clips: 29, level: 1 },
  { id: 'r79', name: 'SengSengSengSengSeng', seasonPoints: 150, weekPoints: 390, clips: 38, level: 1 },
  { id: 'r80', name: 'Ava Christensen', seasonPoints: 130, weekPoints: 180, clips: 24, level: 1 },
  { id: 'r81', name: 'TouVang420', seasonPoints: 110, weekPoints: 310, clips: 31, level: 1 },
  { id: 'r82', name: 'Zach uh hi', seasonPoints: 95, weekPoints: 140, clips: 19, level: 1 },
  ...
  { id: 'r85', name: 'lub paj zoo nkauj', seasonPoints: 50, weekPoints: 180, clips: 22, level: 1 },
  { id: 'r86', name: 'Hailey P', seasonPoints: 40, weekPoints: 75, clips: 8, level: 1 },
  { id: 'r87', name: 'NhiaNhia', seasonPoints: 30, weekPoints: 140, clips: 15, level: 1 },
  { id: 'r88', name: 'Brock Anderson', seasonPoints: 25, weekPoints: 60, clips: 7, level: 1 },
  { id: 'r89', name: 'KubKub2', seasonPoints: 20, weekPoints: 110, clips: 11, level: 1 },
  { id: 'r90', name: 'Emily Reynold', seasonPoints: 15, weekPoints: 45, clips: 5, level: 1 },
  { id: 'r91', name: 'guccipowhmong', seasonPoints: 12, weekPoints: 95, clips: 9, level: 1 },
  { id: 'r92', name: 'Paige T', seasonPoints: 10, weekPoints: 30, clips: 3, level: 1 },
  { id: 'r93', name: 'VangVibe', seasonPoints: 8, weekPoints: 70, clips: 6, level: 1 },
  { id: 'r94', name: 'trevonte davis', seasonPoints: 6, weekPoints: 25, clips: 2, level: 1 },
  ...
  { id: 'r98', name: 'JOSHUAVANG2026', seasonPoints: 2, weekPoints: 15, clips: 1, level: 1 },
  { id: 'r99', name: 'MouaQueen29', seasonPoints: 1, weekPoints: 10, clips: 1, level: 1 },
